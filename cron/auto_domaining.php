<?
 ...
 ConnectDB();
  ...
  if ($ID>0) {
   ...
   $USERTYPE=get_domain_usertype($DOMAIN);
   if ($USERTYPE==1) {
    $IDADM=$IDREG;
    update_domain($ID,$DOMAIN,$IDREG,$IDADM,$IDTECH,$IDBILL);
   }
   ...
   if ($RESCODE==1000) {
    ...
    webpanel_logs_add("EppProto","$LANGUAGE[438] $DOMAIN, $LANGUAGE[250] $RESCODE, $LANGUAGE[251] $REASONCODE.");
   }
