<?
 ...
 ConnectDB();
  ...
  if ($RESCODE==1000) {
   echo "<br>$LANGUAGE[493] <b>$DOMAIN</b> <br><br>";
   webpanel_logs_add("EppProto","$LANGUAGE[493] $DOMAIN.");
   domain_add_status($IDD,$STATUS);
   update_domain_updating($IDD);
  } else {
   echo "<br>$LANGUAGE[494] <b>$DOMAIN</b> <br><br>";
   webpanel_logs_add("EppProto","$LANGUAGE[494] $DOMAIN, $LANGUAGE[250] $RESCODE, $LANGUAGE[251] $REASONCODE.");
  }
