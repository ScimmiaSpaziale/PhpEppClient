<?
 ...
 ConnectDB();
  ...
  $TLD=validate_string($_POST['tld']);
  $DESC=addslashes($_POST['desc']);
  $ADDRESS=addslashes($_POST['address']);
  $USERNAME=addslashes($_POST['username']);
  $PASSWORD=addslashes($_POST['password']);
  $PROTO=validate_string($_POST['proto']);
  $PORT=validate_unsigned($_POST['port']);

  add_eppserver($TLD,$DESC,$ADDRESS,$USERNAME,$PASSWORD,$PROTO,$PORT);
