<?
 ...
 ConnectDB();
  ...
  $PREFIX=validate_string($_POST['prefix']);
  $DEBUG=validate_string($_POST['debug']);
  $EXAM=validate_string($_POST['exam']);

  update_config($ID_UTENTE,$IDREG,$IDADM,$IDTECH,$IDBILL,$IP1,$IP2,$IP3,$IP4,$IP5,$NS1,$NS2,$NS3,$NS4,$NS5,$PREFIX,$DEBUG,$EXAM);
