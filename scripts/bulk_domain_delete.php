<?
 ...
 ConnectDB();
  ...
  while ($i<$l) {
   ...
   if ($RESCODE==1000) {
    echo "$LANGUAGE[609] <b>$DOMAIN</b> <br><br>";
    webpanel_logs_add("EppProto","$LANGUAGE[609] $DOMAIN.");
   } else {
    echo "$LANGUAGE[610] <b>$DOMAIN</b> <br><br>";
    webpanel_logs_add("EppProto","$LANGUAGE[610] $DOMAIN, $LANGUAGE[384] $RESCODE, $LANGUAGE[385] $REASONCODE.");
   }
