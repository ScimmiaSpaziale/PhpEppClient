<?
 ...
 ConnectDB();
  ...
  if (($RESCODE==1000)||($RESCODE==1001)) {
   echo "$LANGUAGE[473] <b>$DOMAIN</b> <br><br>";
   webpanel_logs_add("EppProto","$LANGUAGE[473] $DOMAIN.");
   ...
   webpanel_logs_add("EppProto","$LANGUAGE[474] $DOMAIN, $LANGUAGE[250] $RESCODE, $LANGUAGE[251] $REASONCODE.");
  }
