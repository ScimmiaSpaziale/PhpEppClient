<?
 ...
 ConnectDB();
  ...
  if ($RESCODE==1000) {
   echo "$LANGUAGE[451] <b>$CID</b> <br><br>";
   webpanel_logs_add("Security","$LANGUAGE[452] $CID.");
   update_contact_status($IDC,"AdminActive");
  } else {
   webpanel_logs_add("Security","$LANGUAGE[453] $CID, $LANGUAGE[250] $RESCODE, $LANGUAGE[251] $REASONCODE.");
