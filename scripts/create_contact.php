<?
 ...
 ConnectDB();
  ...
  $TEL=validate_string($TELPREFIX.".".$TEL);
  $FAX=validate_string($FAXPREFIX.".".$FAX);
  ...
  $IDC=create_contact($NAME,$SURNAME,$COMPANY,$ADDRESS,$ZIP,$CITY,$PROV,$COUNTRY,$NAT,$TC,$TCID,$CF,$VAT,$TEL,$FAX,$EMAIL,$PUB,$SEX);
  add_edu_extcon_xml($IDC,$ISO,$TYP,$REGC,$SCHOOLCODE);
