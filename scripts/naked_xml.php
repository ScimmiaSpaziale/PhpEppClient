<?
 ...
 ConnectDB();
  ...
  $STRIPPING=($_POST['stripping']);
  if ($STRIPPING=="Yes") $XML=stripslashes($_POST['xml']);
   else $XML=$_POST['xml'];
  ...
  webpanel_logs_add("EppProto","$LANGUAGE[461] $RESCODE, $REASONCODE");

  print_debug_info($xml,"xmlform",120,20,$RESCODE,$REASONCODE,$ID_EPPSESSION);
