<?
 ...
 ConnectDB();
  ...
  $TIPO=validate_unsigned($_POST['TIPO']);
  $STATO=validate_string($_POST['STATO']);

  $NAME=validate_string($_POST['NOME']);
  $SURNAME=validate_string($_POST['COGNOME']);
  $EMAIL=validate_string($_POST['EMAIL']);

  $USERNAME=validate_string($_POST['USERNAME']);
  $PASSWORD=validate_string($_POST['PASSWORD']);

  aggiorna_dati_utente($ID,$USERNAME,$PASSWORD,$NAME,$SURNAME,$EMAIL,$TIPO,$STATO);
