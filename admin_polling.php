    ...
    print_div_open("middle_container_id","middle_container_full");
     ...
     print_div_open("fullmiddle_col_id","fullmiddle_col");
      ...
      if (($RESCODE!=1300)&&($RESCODE!=1301)) {
       ...
       if ($RESCODE==1300) {
        echo "$LANGUAGE[396] <br>";
        webpanel_logs_add("EppProto","$LANGUAGE[396]");
       }
       if ($RESCODE==1301) {
        echo "$LANGUAGE[397] <br>";
        webpanel_logs_add("EppProto","$LANGUAGE[397]");
      ...
      print_debug_info_polling($xml,"polling",80,12,$RESCODE,$REASONCODE,$ID_EPPSESSION);
