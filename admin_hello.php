   ...
   print_html_menu();
    ...
    print_div_open("middle_container_id","middle_container_full");
     ...
     print_div_open("fullmiddle_col_id","fullmiddle_col");
      ...
      $xml=epp_hello($eppsock,$ID_ADMIN);
      $MICRO2=microtime_float();
      $MICRO=$MICRO2-$MICRO1;

      webpanel_logs_add("EppProto","$LANGUAGE[388] $LANGUAGE[389] $MICRO");
      echo "<div align=left>&nbsp; $LANGUAGE[388] $LANGUAGE[389] $MICRO</div><br>";

      print_debug_info($xml,"hellobox",80,12,$RESCODE,$REASONCODE,$ID_EPPSESSION);
