   ...
   print_html_menu();
    ...
    print_div_open("middle_container_id","middle_container_full");
     ...
     print_div_open("fullmiddle_col_id","fullmiddle_col");
      ...
      echo "<br> $LANGUAGE[398] <b>$ID</b> / <b>$CID</b> <br><br>";
      ...
      if ($RESCODE!=1000) {
       ...
       echo "$LANGUAGE[380] <br><br>";
       xml_print_contact_info($xml);
       webpanel_logs_add("EppProto","$LANGUAGE[380]");
      }

      print_debug_info($xml,"contactinfo",80,12,$RESCODE,$REASONCODE,$ID_EPPSESSION);
